local lang = {
  ...
  ["manage_configurations"] = {
    ...
    ["checks"] = "Проверки",
    ["config_import"] = "Импортировать <span class='item'>{{ type }}</span> Конфигурацию",
  ...
  ["widgets_page"] = {
    ...
    ["modal"] = {
      ...
      ["delete_description"] = "Вы точно хотите удалить <b>%{widget}</b>? Виджеты страницы также будут удалены",
      ["delete_widget"] = "Удалить Виджет: %{widget}",
      ["edit_widget"] = "Редактировать Виджет: %{widget}",
      ["embed_widget"] = "Вставить тэг Виджета",
      ["embed_widget_desc_1"] = "Скопируйте и вставьте этот <b>HTML</b> тэг на вашу страницу",
      ["embed_widget_desc_2"] = "Убедитесь в том, что вы добавили скрипт Виджета ntop <code>ntop-widgets.js</code> на вашу страницу.",
    },
    ["validation"] = {
